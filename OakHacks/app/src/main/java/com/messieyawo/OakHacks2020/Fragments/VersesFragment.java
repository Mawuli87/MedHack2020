...
import com.messieyawo.OakHacks2020.DalyVerses.DailyVerses;
import com.messieyawo.OakHacks2020.DalyVerses.FirebaseDatabaseHelper;
import com.messieyawo.OakHacks2020.DalyVerses.RecyclerViewConfig;

import com.messieyawo.OakHacks2020.MainActivity;
...
private RecyclerView mRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       FloatingActionButtonExpandable fab = view.findViewById(R.id.fab);
        ...
        typedTextView.setTypedText( "Welcome to OakHacks.We know being in quarantine is tough and boring! The solution an online Hackathon");
    ...
    private void sendNotification() {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(getActivity(),"n")
                .setAutoCancel(true)
                .setSmallIcon(R.drawable.small_eagle)
                .setContentTitle("Word Bride Fellowship")
    ...
    public void EventNotify(){
        ...
        NotifyMe notifyMe = new NotifyMe.Builder(getContext())
                .title("Word Bride Fellowship.")
                .content("Brothers and Sisters, the daily verse is updated.")
                .color(255,0,0,255)
    ...
    public void NotificationChannel(){
       ...
       String tiTle = "Word Bride Fellowship";
       String body = "W.B.F Daily Bible Verse Update by: ";
...
//        //NoPendingIntent.getBroadcast(getContext(), 0, NoIntent, PendingIntent.FLAG_UPDATE_CURRENT).cancel();
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.O){
            ...
            builder.setSmallIcon(R.drawable.oak);
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.oak);
