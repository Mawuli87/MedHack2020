package com.messieyawo.OakHacks2020.Testimonials;
...
import com.messieyawo.OakHacks2020.EvntManager.EventFirebaseDatabaseHelper;
import com.messieyawo.OakHacks2020.EvntManager.EventObject;
        ...
        btFloat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new FancyAlertDialog.Builder(getActivity())
                        ...
                        .setMessage("All posts here must abide to the rules. " +
                                "and understand the policies that rules posting testimonies here as indicated.Your testimony will be seen everywhere " +
                            ...
                            public void OnClick() {
                                ...
                                saveBtnTestimony.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        testimonials.setDate(mDate.getText().toString());
                                       testimonials.setDescription(mDescription.getText().toString());
                                        testimonials.setName(mName.getText().toString());
                                        testimonials.setTitle(mTitle.getText().toString());
                                        testimonials.setLocation(mLocation.getText().toString());
