package com.messieyawo.medhack2020.Slots;
...
//                dbNode.setValue(null);
                new EventFirebaseDatabaseHelper().updateEvent(key,eventObject,new EventFirebaseDatabaseHelper.DataStatus() {
                    ...
                    public void EventDataInserted() {
                        d.dismiss();
                        DynamicToast.makeSuccess(UpdateEventActivity.this, "Today's slot or announcement is updated successfully..", Toast.LENGTH_SHORT).show();
